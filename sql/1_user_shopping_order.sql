CREATE TABLE `order_user_shopping_order` (
  ...
  `gross_amount` DOUBLE(20,4) NOT NULL DEFAULT '0' COMMENT '总金额',
  `freight` DOUBLE(20,4) NOT NULL DEFAULT '0' COMMENT '运费',
  `discounts` DOUBLE(20,4) NOT NULL DEFAULT '0' COMMENT '优惠价格',
  `pay_amount` DOUBLE(20,4) NOT NULL DEFAULT '0' COMMENT '实付金额',
  `shop_score` int(64) unsigned NOT NULL DEFAULT '0' COMMENT '店铺积分抵费用',
